...
Tedy poté\\
$x: 5 \mapsto 5 \cdot 9 \equiv 18 \mod 27 $\\
$y: 2 \mapsto 2 \cdot 9 \equiv 18 \mod 27 $\\
Tedy dvě různé zprávy (čísla) se zašifrují na stejné číslo. Dvojice tedy je např. $(9,0)$.
Stejně tak to funguje i pro $k=3$
\section\\
